...
from videos.models import Creator
import random
import bcrypt
...
class MobileVerifyView(APIView):
    def post(self, request):
        ...
        is_creator = Creator.objects.filter(phone_number=phone_number).exists()
        ...
        return Response({"status_code": 200, "message": "OTP sent successfully", "otp": otp,"is_creator":is_creator}, status=status.HTTP_200_OK)
