...
class VideoAddSerializer(serializers.ModelSerializer):
    class Meta:
        model = Video
        fields = ["title", "description", "video_file", "video_size", "views",'thumb_image' ,"created_at"]
        read_only_fields = ["video_size", "views", "created_at",'creator']
...
class CreatorDetailSerializer(serializers.ModelSerializer):
    class Meta:
        model = Creator
        fields = ['id', 'name', 'role', 'about_us','phone_number', 'views', 'total_videos']
...
class CreatorAddSerializer(serializers.ModelSerializer):
    class Meta:
        model = Creator
        fields = ['name', 'role',  'total_videos','about_us','phone_number', 'views','profile_image']
